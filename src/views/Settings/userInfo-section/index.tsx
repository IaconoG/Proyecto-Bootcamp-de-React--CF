...
const UserInfoSection: React.FC = () => {
  ...
  const [isInputProvinceActive, setIsInputProvinceActive] = useState<boolean>(false);
  ...
  //     <form action={handleSubmit} defaultValue={userData} className={styles.formLayout}>
  //       <input
  //         id="userName"
  //         name="userName"
  ...
  //         maxLength={60}
  //       />
  //       <Select id="occupation" name="occupation" options={selectOptions} className={styles.selectStyles} />
  ...
  //           autoComplete="off"
  //         />
  //         <Datalist id="province-options" options={provinces} styles={styles.input} />
  //       </div>
